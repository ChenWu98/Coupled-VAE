...
def get_embedding(names, wv_type='glove.840B', wv_dir='data', wv_dim=300, for_eval=False):
    if wv_type+str(300) in loaded:
        wv_dict, wv_arr, wv_size = loaded[wv_type+str(300)]
    else:
        wv_dict, wv_arr, wv_size = load_word_vectors(wv_dir, wv_type, wv_dim)
        loaded[wv_type+str(300)] = (wv_dict, wv_arr, wv_size)
